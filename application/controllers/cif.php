...
class Cif extends GMN_Controller
{
	...
	public function add_cif_kelompok()
	{
		...
		$data_cif = array(
			'nama' 					=> ($step1_nama == "") ? null : $step1_nama, 'cif_id' 					=> ($cif_id == "") ? null : $cif_id, 'cm_code' 					=> ($cm_code == "") ? null : $cm_code, 'tgl_gabung' 				=> ($step1_tanggal_gabung == "") ? null : $step1_tanggal_gabung, 'panggilan' 				=> ($step1_panggilan == "") ? null : $step1_panggilan, 'kelompok' 				=> ($step1_kelompok == "") ? null : $step1_kelompok, 'jenis_kelamin' 			=> ($step2_pribadi_jenis_kelamin == "") ? null : $step2_pribadi_jenis_kelamin, 'ibu_kandung' 				=> ($step2_pribadi_ibu_kandung == "") ? null : $step2_pribadi_ibu_kandung, 'tmp_lahir' 				=> ($step2_pribadi_tmp_lahir == "") ? null : $step2_pribadi_tmp_lahir, 'tgl_lahir' 				=> ($step2_pribadi_tgl_lahir == "--") ? null : $step2_pribadi_tgl_lahir, 'usia' 					=> ($step2_pribadi_usia == "") ? null : $step2_pribadi_usia, 'no_ktp' 					=> ($step2_pribadi_no_ktp == "") ? null : $step2_pribadi_no_ktp, 'no_hp' 					=> ($step2_pribadi_no_hp == "") ? null : $step2_pribadi_no_hp, 'alamat' 					=> ($step2_pribadi_alamat == "") ? null : $step2_pribadi_alamat, 'rt_rw' 					=> ($step2_pribadi_rt . '/' . $step2_pribadi_rw == "") ? null : $step2_pribadi_rt . '/' . $step2_pribadi_rw, 'desa' 					=> ($step2_pribadi_desa == "") ? null : $step2_pribadi_desa, 'kecamatan' 				=> ($step2_pribadi_kecamatan == "") ? null : $step2_pribadi_kecamatan, 'kabupaten' 				=> ($step2_pribadi_kabupaten == "") ? null : $step2_pribadi_kabupaten, 'kodepos' 					=> ($step2_pribadi_kodepos == "") ? null : $step2_pribadi_kodepos, 'koresponden_alamat' 		=> ($step2_pribadi_koresponden_alamat == "") ? null : $step2_pribadi_koresponden_alamat, 'koresponden_rt_rw' 		=> ($step2_pribadi_koresponden_rt . '/' . $step2_pribadi_koresponden_rw == "") ? null : $step2_pribadi_koresponden_rt . '/' . $step2_pribadi_koresponden_rw, 'koresponden_desa' 		=> ($step2_pribadi_koresponden_desa == "") ? null : $step2_pribadi_koresponden_desa, 'koresponden_kecamatan' 	=> ($step2_pribadi_koresponden_kecamatan == "") ? null : $step2_pribadi_koresponden_kecamatan, 'koresponden_kabupaten' 	=> ($step2_pribadi_koresponden_kabupaten == "") ? null : $step2_pribadi_koresponden_kabupaten, 'koresponden_kodepos' 		=> ($step2_pribadi_koresponden_kodepos == "") ? null : $step2_pribadi_koresponden_kodepos, 'pendidikan' 				=> ($step2_pribadi_pendidikan == "") ? null : $step2_pribadi_pendidikan, 'pekerjaan' 				=> ($step2_pribadi_pekerjaan == "") ? null : $step2_pribadi_pekerjaan, 'ket_pekerjaan' 			=> ($step2_pribadi_ket_pekerjaan == "") ? null : $step2_pribadi_ket_pekerjaan, 'branch_code' 				=> $branch_code, 'cif_type' 				=> 0, 'status' 					=> 1
		);
		$data_cif_kelompok = array(
			'setoran_lwk' 				=> ($step1_setoran_lwk == "") ? null : $step1_setoran_lwk, 'cif_id' 					=> ($cif_id == "") ? null : $cif_id, 'setoran_mingguan' 		=> ($step1_setoran_mingguan == "") ? null : $step1_setoran_mingguan, 'literasi_latin' 			=> ($step2_pribadi_literasi_latin == true) ? $step2_pribadi_literasi_latin : 0, 'literasi_arab' 			=> ($step2_pribadi_literasi_arab == true) ? $step2_pribadi_literasi_arab : 0, 'pendapatan' 				=> ($step2_pribadi_pendapatan == "") ? null : $step2_pribadi_pendapatan, 'p_nama' 					=> ($step2_pasangan_nama == "") ? null : $step2_pasangan_nama, 'p_tmplahir' 				=> ($step2_pasangan_tmplahir == "") ? null : $step2_pasangan_tmplahir, 'p_tglahir' 				=> ($step2_pasangan_tglahir == "--") ? null : $step2_pasangan_tglahir, 'p_usia' 					=> ($step2_pasangan_usia == "") ? null : $step2_pasangan_usia, 'p_no_ktp' 				=> ($step2_pasangan_no_ktp == "") ? null : $step2_pasangan_no_ktp, 'p_no_hp' 					=> ($step2_pasangan_no_hp == "") ? null : $step2_pasangan_no_hp, 'pengguna_dana'			=> ($step2_pribadi_pengguna_dana == "") ? null : $step2_pribadi_pengguna_dana, 'p_pendidikan' 			=> ($step2_pasangan_pendidikan == "") ? null : $step2_pasangan_pendidikan, 'p_pekerjaan' 				=> ($step2_pasangan_pekerjaan == "") ? null : $step2_pasangan_pekerjaan, 'p_ketpekerjaan'			=> ($step2_pasangan_ketpekerjaan == "") ? null : $step2_pasangan_ketpekerjaan, 'p_pendapatan' 			=> ($step2_pasangan_pendapatan == "") ? null : $step2_pasangan_pendapatan, 'p_periodependapatan' 		=> ($step2_pasangan_pendapatan == "") ? null : $step2_pasangan_pendapatan, 'p_literasi_latin' 		=> ($step2_pasangan_literasi_latin == true) ? $step2_pasangan_literasi_latin : 0, 'p_literasi_arab' 			=> ($step2_pasangan_literasi_arab == true) ? $step2_pasangan_literasi_arab : 0, 'p_jmltanggungan' 			=> ($step2_pasangan_jmltanggungan == "") ? null : $step2_pasangan_jmltanggungan, 'p_jmlkeluarga'	 		=> ($step2_pasangan_jmlkeluarga == "") ? null : $step2_pasangan_jmlkeluarga, 'rmhstatus' 				=> ($step3_rmhstatus == "") ? null : $step3_rmhstatus, 'rekening_listrik' 		=> ($step3_rekening_listrik == "") ? null : $step3_rekening_listrik, 'rekening_listrik_biaya' 	=> ($step3_rekening_listrik_biaya == "") ? null : $step3_rekening_listrik_biaya, 'rekening_pdam' 			=> ($step3_rekening_pdam == "") ? null : $step3_rekening_pdam, 'rekening_pdam_biaya' 		=> ($step3_rekening_pdam_biaya == "") ? null : $step3_rekening_pdam_biaya, 'bpjs' 					=> ($step3_bpjs == "") ? null : $step3_bpjs, 'bpjs_biaya' 				=> ($step3_bpjs_biaya == "") ? null : $step3_bpjs_biaya, 'rmhukuran' 				=> ($step3_rmhukuran == "") ? null : $step3_rmhukuran, 'rmhatap' 					=> ($step3_rmhatap == "") ? null : $step3_rmhatap, 'rmhdinding' 				=> ($step3_rmhdinding == "") ? null : $step3_rmhdinding, 'rmhlantai' 				=> ($step3_rmhlantai == "") ? null : $step3_rmhlantai, 'rmhjamban' 				=> ($step3_rmhjamban == "") ? null : $step3_rmhjamban, 'rmhair' 					=> ($step3_rmhair == "") ? null : $step3_rmhair, 'lahansawah' 				=> ($step3_lahansawah == "") ? null : $step3_lahansawah, 'lahankebun' 				=> ($step3_lahankebun == "") ? null : $step3_lahankebun, 'lahanpekarangan' 			=> ($step3_lahanpekarangan == "") ? null : $step3_lahanpekarangan, 'ternakkerbau' 			=> ($step3_sapi_ternakkerbau == "") ? null : $step3_sapi_ternakkerbau, 'ternakdomba' 				=> ($step3_ternakdomba == "") ? null : $step3_ternakdomba, 'ternakunggas' 			=> ($step3_ternakunggas == "") ? null : $step3_ternakunggas, 'elektape' 				=> ($step3_elektape == false) ? 0 : $step3_elektape, 'elektv' 					=> ($step3_elektv == false) ? 0 : $step3_elektv, 'elekplayer' 				=> ($step3_elekplayer == false) ? 0 : $step3_elekplayer, 'elekkulkas' 				=> ($step3_elekkulkas == false) ? 0 : $step3_elekkulkas, 'kendsepeda' 				=> ($step3_kendsepeda == "") ? null : $step3_kendsepeda, 'kendmotor' 				=> ($step3_kendmotor == "") ? null : $step3_kendmotor, 'ushrumahtangga' 			=> ($step4_ushrumahtangga == "") ? null : $step4_ushrumahtangga, 'ushkomoditi' 				=> ($step4_ushkomoditi == "") ? null : $step4_ushkomoditi, 'ushlokasi' 				=> ($step4_ushlokasi == "") ? null : $step4_ushlokasi, 'ushomset' 				=> ($step4_ushomset == "") ? null : $step4_ushomset, 'byaberas' 				=> ($step4_byaberas == "") ? null : $step4_byaberas, 'byadapur' 				=> ($step4_byadapur == "") ? null : $step4_byadapur, 'byalistrik' 				=> ($step4_byalistrik == "") ? null : $step4_byalistrik, 'byatelpon' 				=> ($step4_byatelpon == "") ? null : $step4_byatelpon, 'byasekolah'	 			=> ($step4_byasekolah == "") ? null : $step4_byasekolah, 'byalain' 					=> ($step4_byalain == "") ? null : $step4_byalain, 'sku_no' 					=> $sku_no
		);
	...
	public function update_cif_kelompok()
	{
		...
		$data_cif = array(
			...
			, 'tgl_gabung' 					=> ($step1_tanggal_gabung == "") ? null : $step1_tanggal_gabung, 'panggilan' 					=> ($step1_panggilan == "") ? null : $step1_panggilan, 'kelompok' 					=> ($step1_kelompok == "") ? null : $step1_kelompok, 'jenis_kelamin' 				=> ($step2_pribadi_jenis_kelamin == "") ? null : $step2_pribadi_jenis_kelamin, 'ibu_kandung' 					=> ($step2_pribadi_ibu_kandung == "") ? null : $step2_pribadi_ibu_kandung, 'tmp_lahir' 					=> ($step2_pribadi_tmp_lahir == "") ? null : $step2_pribadi_tmp_lahir, 'tgl_lahir' 					=> ($step2_pribadi_tgl_lahir == "") ? null : $step2_pribadi_tgl_lahir, 'usia' 						=> ($step2_pribadi_usia == "") ? null : $step2_pribadi_usia, 'no_ktp' 						=> ($step2_pribadi_no_ktp == "") ? null : $step2_pribadi_no_ktp, 'no_hp' 						=> ($step2_pribadi_no_hp == "") ? null : $step2_pribadi_no_hp, 'alamat' 						=> ($step2_pribadi_alamat == "") ? null : $step2_pribadi_alamat, 'rt_rw' 						=> @$step2_pribadi_rt . '/' . $step2_pribadi_rw, 'desa' 						=> ($step2_pribadi_desa == "") ? null : $step2_pribadi_desa, 'kecamatan' 					=> ($step2_pribadi_kecamatan == "") ? null : $step2_pribadi_kecamatan, 'kabupaten' 					=> ($step2_pribadi_kabupaten == "") ? null : $step2_pribadi_kabupaten, 'kodepos' 						=> ($step2_pribadi_kodepos == "") ? null : $step2_pribadi_kodepos, 'koresponden_alamat' 			=> ($step2_pribadi_koresponden_alamat == "") ? null : $step2_pribadi_koresponden_alamat, 'koresponden_rt_rw' 			=> $step2_pribadi_koresponden_rt . '/' . $step2_pribadi_koresponden_rw, 'koresponden_desa' 			=> ($step2_pribadi_koresponden_desa == "") ? null : $step2_pribadi_koresponden_desa, 'koresponden_kecamatan' 		=> ($step2_pribadi_koresponden_kecamatan == "") ? null : $step2_pribadi_koresponden_kecamatan, 'koresponden_kabupaten' 		=> ($step2_pribadi_koresponden_kabupaten == "") ? null : $step2_pribadi_koresponden_kabupaten, 'koresponden_kodepos' 			=> ($step2_pribadi_koresponden_kodepos == "") ? null : $step2_pribadi_koresponden_kodepos, 'pendidikan' 					=> ($step2_pribadi_pendidikan == "") ? null : $step2_pribadi_pendidikan, 'pekerjaan' 					=> ($step2_pribadi_pekerjaan == "") ? null : $step2_pribadi_pekerjaan, 'ket_pekerjaan' 				=> ($step2_pribadi_ket_pekerjaan == "") ? null : $step2_pribadi_ket_pekerjaan
			// ,'branch_code' 					=> $this->session->userdata('branch_code')
		);
		$data_cif_kelompok = array(
			'setoran_lwk' 					=> @$step1_setoran_lwk
			// ,'cif_id' 					=> $cif_id
			, 'setoran_mingguan' 			=> ($step1_setoran_mingguan == "") ? null : $step1_setoran_mingguan, 'literasi_latin' 				=> ($step2_pribadi_literasi_latin == true) ? $step2_pribadi_literasi_latin : 0, 'literasi_arab' 				=> ($step2_pribadi_literasi_arab == true) ? $step2_pribadi_literasi_arab : 0, 'pendapatan' 					=> ($step2_pribadi_pendapatan == "") ? null : $step2_pribadi_pendapatan, 'p_nama' 						=> ($step2_pasangan_nama == "") ? null : $step2_pasangan_nama, 'p_tmplahir' 					=> ($step2_pasangan_tmplahir == "") ? null : $step2_pasangan_tmplahir, 'p_tglahir' 					=> ($step2_pasangan_tglahir == "--") ? null : $step2_pasangan_tglahir, 'p_usia' 						=> ($step2_pasangan_usia == "") ? null : $step2_pasangan_usia, 'p_no_ktp' 					=> ($step2_pasangan_no_ktp == "") ? null : $step2_pasangan_no_ktp, 'p_no_hp' 						=> ($step2_pasangan_no_hp == "") ? null : $step2_pasangan_no_hp, 'pengguna_dana'				=> ($step2_pribadi_pengguna_dana == "") ? null : $step2_pribadi_pengguna_dana, 'p_pendidikan' 				=> ($step2_pasangan_pendidikan == "") ? null : $step2_pasangan_pendidikan, 'p_pekerjaan' 					=> ($step2_pasangan_pekerjaan == "") ? null : $step2_pasangan_pekerjaan, 'p_ketpekerjaan' 				=> ($step2_pasangan_ketpekerjaan == "") ? null : $step2_pasangan_ketpekerjaan, 'p_pendapatan' 				=> ($step2_pasangan_pendapatan == "") ? null : $step2_pasangan_pendapatan, 'p_periodependapatan' 			=> ($step2_pasangan_pendapatan == "") ? null : $step2_pasangan_pendapatan, 'p_literasi_latin' 			=> ($step2_pasangan_literasi_latin == true) ? $step2_pasangan_literasi_latin : 0, 'p_literasi_arab' 				=> ($step2_pasangan_literasi_arab == true) ? $step2_pasangan_literasi_arab : 0, 'p_jmltanggungan' 				=> ($step2_pasangan_jmltanggungan == "") ? null : $step2_pasangan_jmltanggungan, 'p_jmlkeluarga' 				=> ($step2_pasangan_jmlkeluarga == "") ? null : $step2_pasangan_jmlkeluarga, 'rmhstatus' 					=> ($step3_rmhstatus == "") ? null : $step3_rmhstatus, 'rekening_listrik' 			=> ($step3_rekening_listrik == "") ? null : $step3_rekening_listrik, 'rekening_listrik_biaya' 		=> ($step3_rekening_listrik_biaya == "") ? null : $step3_rekening_listrik_biaya, 'rekening_pdam' 				=> ($step3_rekening_pdam == "") ? null : $step3_rekening_pdam, 'rekening_pdam_biaya' 			=> ($step3_rekening_pdam_biaya == "") ? null : $step3_rekening_pdam_biaya, 'bpjs' 						=> ($step3_bpjs == "") ? null : $step3_bpjs, 'bpjs_biaya' 					=> ($step3_bpjs_biaya == "") ? null : $step3_bpjs_biaya, 'rmhukuran' 					=> ($step3_rmhukuran == "") ? null : $step3_rmhukuran, 'rmhatap' 						=> ($step3_rmhatap == "") ? null : $step3_rmhatap, 'rmhdinding' 					=> ($step3_rmhdinding == "") ? null : $step3_rmhdinding, 'rmhlantai' 					=> ($step3_rmhlantai == "") ? null : $step3_rmhlantai, 'rmhjamban' 					=> ($step3_rmhjamban == "") ? null : $step3_rmhjamban, 'rmhair' 						=> ($step3_rmhair == "") ? null : $step3_rmhair, 'lahansawah' 					=> ($step3_lahansawah == "") ? null : $step3_lahansawah, 'lahankebun' 					=> ($step3_lahankebun == "") ? null : $step3_lahankebun, 'lahanpekarangan' 				=> ($step3_lahanpekarangan == "") ? null : $step3_lahanpekarangan, 'ternakkerbau' 				=> ($step3_sapi_ternakkerbau == "") ? null : $step3_sapi_ternakkerbau, 'ternakdomba' 					=> ($step3_ternakdomba == "") ? null : $step3_ternakdomba, 'ternakunggas' 				=> ($step3_ternakunggas == "") ? null : $step3_ternakunggas, 'elektape' 					=> ($step3_elektape == false) ? 0 : $step3_elektape, 'elektv' 						=> ($step3_elektv == false) ? 0 : $step3_elektv, 'elekplayer' 					=> ($step3_elekplayer == false) ? 0 : $step3_elekplayer, 'elekkulkas' 					=> ($step3_elekkulkas == false) ? 0 : $step3_elekkulkas, 'kendsepeda' 					=> ($step3_kendsepeda == "") ? null : $step3_kendsepeda, 'kendmotor'	 				=> ($step3_kendmotor == "") ? null : $step3_kendmotor, 'ushrumahtangga' 				=> ($step4_ushrumahtangga == "") ? null : $step4_ushrumahtangga, 'ushkomoditi' 					=> ($step4_ushkomoditi == "") ? null : $step4_ushkomoditi, 'ushlokasi' 					=> ($step4_ushlokasi == "") ? null : $step4_ushlokasi, 'ushomset' 					=> ($step4_ushomset == "") ? null : $step4_ushomset, 'byaberas' 					=> ($step4_byaberas == "") ? null : $step4_byaberas, 'byadapur' 					=> ($step4_byadapur == "") ? null : $step4_byadapur, 'byalistrik' 					=> ($step4_byalistrik == "") ? null : $step4_byalistrik, 'byatelpon' 					=> ($step4_byatelpon == "") ? null : $step4_byatelpon, 'byasekolah' 					=> ($step4_byasekolah == "") ? null : $step4_byasekolah, 'byalain' 						=> ($step4_byalain == "") ? null : $step4_byalain
		);
	...
	public function datatable_target_cabang()
	{
		...
		$branch_code = @$_GET['branch_code'];
		$aColumns = array('', 'tahun', 'target_item', 't1', 't2', 't3', 't4', 't5', 't6', 't7', 't8', 't9', 't10', 't11', 't12');
		...
		foreach ($rResult as $aRow) {
			...
			$row[] = '<a href="javascript:;" cm_id="' . $aRow['target_id'] . '" id="link-edit">Edit</a>';
	...
	public function edit_rembug()
	{
		...
		$data = array(
			'cm_name'			=> $cm_name, 'fa_code'  			=> $fa_code, 'hari_transaksi'	=> $hari_transaksi, 'desa_code'			=> $desa_code
		);
	...
	{
		$data 			= $this->model_cif->search_item();
	...
	public function add_cif_individu()
	{
		...
		$data = array(
			'nama' 					=> ($nama == "") ? null : $nama, 'tgl_gabung' 				=> ($tgl_gabung == "") ? null : $tgl_gabung, 'panggilan' 				=> ($panggilan == "") ? null : $panggilan, 'jenis_kelamin' 			=> ($jenis_kelamin == "") ? null : $jenis_kelamin, 'ibu_kandung' 				=> ($ibu_kandung == "") ? null : $ibu_kandung, 'tmp_lahir' 				=> ($tmp_lahir == "") ? null : $tmp_lahir, 'tgl_lahir' 				=> ($tgl_lahir == "") ? null : $tgl_lahir, 'usia' 					=> ($usia == "") ? null : $usia, 'alamat' 					=> ($alamat == "") ? null : $alamat, 'rt_rw' 					=> $rt . '/' . $rw, 'desa' 					=> ($desa == "") ? null : $desa, 'kecamatan' 				=> ($kecamatan == "") ? null : $kecamatan, 'kabupaten' 				=> ($kabupaten == "") ? null : $kabupaten, 'kodepos'	 				=> ($kode_pos == "") ? null : $kode_pos, 'koresponden_alamat' 		=> ($koresponden_alamat == "") ? null : $koresponden_alamat, 'koresponden_rt_rw' 		=> $koresponden_rt . '/' . $koresponden_rw, 'koresponden_desa' 		=> ($koresponden_desa == "") ? null : $koresponden_desa, 'koresponden_kecamatan' 	=> ($koresponden_kecamatan == "") ? null : $koresponden_kecamatan, 'koresponden_kabupaten' 	=> ($koresponden_kabupaten == "") ? null : $koresponden_kabupaten, 'koresponden_kodepos' 		=> ($koresponden_kode_pos == "") ? null : $koresponden_kode_pos, 'no_ktp' 					=> ($no_ktp == "") ? null : $no_ktp, 'telpon_rumah' 			=> ($telpon_rumah == "") ? null : $telpon_rumah, 'no_npwp' 					=> ($no_npwp == "") ? null : $no_npwp, 'pendidikan' 				=> ($pendidikan == "") ? null : $pendidikan, 'status_perkawinan' 		=> ($status_perkawinan == "") ? null : $status_perkawinan
			//,'identitas_pasangan' 		=> ($identitas_pasangan=="") ? null : $identitas_pasangan
			, 'pekerjaan' 				=> ($pekerjaan == "") ? null : $pekerjaan, 'pendapatan_perbulan'	 	=> ($pendapatan == "") ? null : $pendapatan, 'ket_pekerjaan' 			=> ($keterangan_pekerjaan == "") ? null : $keterangan_pekerjaan, 'cif_type' 				=> 1, 'status' 				=> 1, 'branch_code' 				=> $this->session->userdata('branch_code')
		);
	...
	public function update_cif_individu()
	{
		...
		$param = array('cif_id' => $cif_id);
		$data = array(
			'nama' 					=> $nama, 'panggilan' 				=> $panggilan, 'jenis_kelamin' 			=> $jenis_kelamin, 'ibu_kandung' 				=> $ibu_kandung, 'tmp_lahir' 				=> $tmp_lahir, 'tgl_gabung' 				=> $tgl_gabung, 'tgl_lahir' 				=> $tgl_lahir, 'usia' 					=> $usia, 'alamat' 					=> $alamat, 'rt_rw' 					=> $rt . '/' . $rw, 'desa' 					=> $desa, 'kecamatan' 				=> $kecamatan, 'kabupaten' 				=> $kabupaten, 'kodepos' 					=> $kode_pos, 'koresponden_alamat' 		=> $koresponden_alamat, 'koresponden_rt_rw' 		=> $koresponden_rt . '/' . $koresponden_rw, 'koresponden_desa' 		=> $koresponden_desa, 'koresponden_kecamatan' 	=> $koresponden_kecamatan, 'koresponden_kabupaten' 	=> $koresponden_kabupaten, 'koresponden_kodepos' 		=> $koresponden_kode_pos, 'no_ktp' 					=> $no_ktp, 'telpon_rumah' 			=> $telpon_rumah, 'no_npwp' 					=> $no_npwp, 'pendidikan' 				=> $pendidikan, 'status_perkawinan' 		=> $status_perkawinan
			// ,'identitas_pasangan' 		=> $identitas_pasangan
			, 'pekerjaan' 				=> $pekerjaan, 'pendapatan_perbulan' 		=> $pendapatan, 'ket_pekerjaan' 			=> $keterangan_pekerjaan
		);
	...
	*/
				...
				switch ($v_flag_setoran) {
					case '0': // setoran pokok
						...
						if ($total_tabungan >= $sisa_setoran_pokok) {
							...
							// create history trx
							$arr_trx_pokok[] = array(
								'cif_no' => $v_cif_no, 'trx_type' => 0, 'setor_tabungan_wajib' => $setor_tabungan_wajib, 'setor_tabungan_kelompok' => $setor_tabungan_kelompok, 'total_setoran' => $setoran_pokok, 'trx_date' => $tanggal, 'created_by' => $this->session->userdata('user_id'), 'trx_status' => 1, 'verify_by' => $this->session->userdata('user_id'), 'verify_date' => date('Y-m-d H:i:s')
							);
					...
					case '1': // setoran wajib
						...
						if ($total_tabungan >= $sisa_setoran_wajib) {
							...
							// create history trx
							$arr_trx_wajib[] = array(
								'cif_no' => $v_cif_no, 'trx_type' => 0, 'tabungan_wajib' => $setor_tabungan_wajib, 'tabungan_kelompok' => $setor_tabungan_kelompok, 'total' => $setoran_wajib, 'trx_date' => $tanggal, 'created_by' => $this->session->userdata('user_id'), 'trx_status' => 1, 'verify_by' => $this->session->userdata('user_id'), 'verify_date' => date('Y-m-d H:i:s')
							);
	...
	function jqgrid_setoran_pokok()
	{
		...
		foreach ($result as $row) {
			...
			$responce['rows'][$i]['cell'] = array(
				$row['id'], $row['cif_no'], $row['nama'], $row['tabungan_wajib'], $row['tabungan_kelompok'], $row['simpanan_pokok'], $row['smk']
			);
			$i++;
		}
	...
	function proses_cek_ktp_anggota()
	{
		...
		foreach ($result as $row) {
			...
			$responce['rows'][$i]['cell'] = array(
				$row['branch_name'], $row['cm_name'], $row['cif_no'], $row['nama'], $row['tgl_gabung']
			);
			$i++;
		}
