...
>>>>>>> fa72a87dd8587cd62a2c3aecb932f9d1cda64dda
    ...
    function export_list_proyeksi_angsuran()
    {
        ...
        for ($i = 0; $i < count($datas); $i++) {
            ...
            if ($proyeksi_count > $jangka_waktu) {
                $proyeksi_count = $jangka_waktu;
            };
            $proyeksi_count2    = $result['proyeksi_count2'] - $result['hari_libur2'];
            if ($proyeksi_count2 > $jangka_waktu) {
                $proyeksi_count2 = $jangka_waktu;
            };
            ...
            if ($counter_angsuran >= $jangka_waktu) {
                ...
                if ($counter_lebih > 0) {
                    $proyeksi_bayar = $proyeksi_bayar - $counter_lebih;
                };
    ...
    function export_lap_list_outstanding_pembiayaan()
    {
        ...
        if ($cif_type == 0) {
            ...
            for ($i = 0; $i < count($datas); $i++) {
                ...
                if ($seharusnya > $jangka_waktu) {
                    $seharusnya = $jangka_waktu;
                };
