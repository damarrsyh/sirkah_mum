...
*/
    ...
    function export_list_proyeksi_angsuran(){
        ...
        if($pembiayaan == 1) 
          { $jenis = 'Individu'; $data['jenis'] = 'Individu';  $jenis2 = strtoupper($jenis); } 
        else if ($pembiayaan == 0) 
          { $jenis = 'Kelompok'; $data['jenis'] = 'Kelompok'; $jenis2 = strtoupper($jenis); }  
        else 
          { $jenis = 'Semua'; $data['jenis'] = 'Semua'; $jenis2 = strtoupper($jenis); }

        if($kreditur == '00000') { $data['post_kreditur'] = 'SEMUA'; } 
        else  
        {
            $get_kreditur = $this->model_laporan->get_kreditur_by_code($kreditur); 
            $data['post_kreditur'] = $get_kreditur['display_text'];
