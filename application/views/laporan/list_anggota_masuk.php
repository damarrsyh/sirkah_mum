...
<script type="text/javascript">
   ...
   var showin = function() {
      ...
      jQuery("#list485").jqGrid({
         ...
         colNames: ['ID', 'Nama', 'Majelis', 'Tanggal Gabung', 'Jenis Kelamin', 'Ibu Kandung', 'Tempat Lahir', 'Tanggal Lahir', 'Usia', 'Alamat', 'Petugas'],
         colModel: [
   ...
   $("#export_pdf").click(function(e) {
      ...
      tanggal = $("#tanggal").val().replace(/\//g, '');
      tanggal2 = $("#tanggal2").val().replace(/\//g, '');
      window.open(site_url + "laporan_to_pdf/export_list_anggota_masuk/" + branch_code + "/" + cm_code + "/" + fa_code + "/" + tanggal + "/" + tanggal2);
   });
</script>