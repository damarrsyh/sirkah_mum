	...
	<div class="row-fluid">
		...
		<div class="row-fluid">
			...
			<div class="col-sm-12 ">
				<div class="portlet box blue" id="wrapper-table">
					<div class="portlet-title">
						<div class="caption"><i class="icon-group"></i>Penerimaan Angsuran Bulan Berjalan : <?php echo number_format( $payment['payment'],0,',','.'); ?> </div>
						<div class="tools">
							<a href="javascript:;" class="collapse"></a>
						</div>
					</div>
