         ...
         <form action="javascript:;" method="post">
            ...
            <table id="filter-form">
               ...
               <tr>
                  <td></td>
                  <td>
                     <button class="green btn" id="showgrid" type="button">Double Detail</button>
                     <button class="green btn" id="koreksix1" type="button">Koreksi Double</button>
                  </td>
               </tr>
               <tr>
                  <td></td>
                  <td>
                     <button class="green btn" id="showgrid2" type="button">Master &lt;&gt; Detail</button>
                     <button class="green btn" id="koreksix2" type="button">Koreksi Master</button>
                  </td>
               </tr>
            </table>
         </form>
...
var koreksi1 = function(){
	...
	jQuery("#list485").jqGrid({
	  url: site_url+'koreksi_angsuran/jqgrid_list_koreksi_angsuran',
	  //data: mydata,
	  datatype: 'json',
	  height: 'auto',
	  autowidth: true,
...
$('#koreksix1').click(function(){
	...
	$.ajax({
		type: 'POST',
		url: site_url+'koreksi_angsuran/proses_koreksi',
		dataType: 'json',
...
var koreksi2 = function(){
	...
	jQuery("#list486").jqGrid({
	  url: site_url+'koreksi_angsuran/jqgrid_list_koreksi_angsuran2',
	  //data: mydata,
	  datatype: 'json',
	  height: 'auto',
	  autowidth: true,
...
$('#koreksix2').click(function(){
	...
	$.ajax({
		type: 'POST',
		url: site_url+'koreksi_angsuran/proses_koreksi2',
		dataType: 'json',
		data: {branch:branch,rembug:rembug},
		success: function(respon){
			var sukses = respon.sukses;
