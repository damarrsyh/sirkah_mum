            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <select id="kas_petugas" name="kas_petugas" class="m-wrap large chosen">
                    ...
                    <?php foreach($kas_petugas as $kaspetugas): ?>
                    <option value="<?php echo $kaspetugas['account_cash_code'] ?>"><?php echo $kaspetugas['account_cash_name'] ?></option>
                    <?php endforeach; ?>
                  </select>
               </div>
            </div> 
            <div class="control-group">
               ...
               <div class="controls">
                  <select id="kas_teller" name="kas_teller" class="m-wrap large chosen">
                    <option value="">SILAHKAN PILIH</option>
                    <?php foreach($kas_teller as $kasteller): ?>
                    <option value="<?php echo $kasteller['account_cash_code'] ?>"><?php echo $kasteller['account_cash_name'] ?></option>
                    <?php endforeach; ?>
                  </select>
               </div>
            </div>
