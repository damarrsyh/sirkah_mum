      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_edit" class="form-horizontal">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input name="tanggal_lahir" id="tgl_lahir" type="text" class="medium m-wrap" style="background-color:#eee;"/>
                  &nbsp;
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input type="text" class=" m-wrap" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" id="jangka_waktu" name="jangka_waktu" style="background-color:#eee;width:30px;"  maxlength="3" /> Bulan/Minggu/Hari
                  <span class="help-inline"></span>
               </div>
            </div> 
            <div class="control-group">
            ...
            <div class="control-group">
               ...
               <div class="controls">
                  <input name="tanggal_lunas" id="input-mask" data-required="1" type="text" class="medium m-wrap" readonly="readonly" style="background-color:#eee;"/>
               </div>
            </div>
            <div class="control-group">
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            form2.trigger('reset');
			   ...
			   $("#form_edit input[name='trx_account_financing_id']").val(trx_account_financing_id);
			   ...
			   $("#form_edit input[name='saldo_catab']").val(number_format(response.saldo_catab,0,',','.'));
               ...
               $("#form_edit input[name='tanggal_jtempo']").val(response.tanggal_jtempo);
               $("#form_edit input[name='saldo_pokok']").val(number_format(response.saldo_pokok_lunas,0,',','.'));
               $("#form_edit input[name='saldo_margin']").val(number_format(response.saldo_margin_lunas,0,',','.'));
               $("#form_edit input[name='saldo_tabungan']").val(number_format(response.saldo_tabungan_lunas,0,',','.'));
			   ...
			   $("#form_edit input[name='tanggal_lunas']").val(response.tanggal_lunas);
			   $("#form_edit input[name='flag_catab']").val(response.flag_catab);
               saldo_pokok      = parseFloat(response.saldo_pokok_lunas);
               saldo_margin     = parseFloat(response.saldo_margin_lunas);
			   saldo_tabungan   = parseFloat(response.saldo_tabungan_lunas);
               potongan_margin  = parseFloat(response.potongan_margin);

			   
			   if(response.jenis_pembayaran == 0){
				   $('#t_cash').show();
				   $('#t_pinbuk').hide();
			   } else {
				   $('#t_cash').hide();
			   ...
			   if(response.flag_catab == 1){
				   ...
				   total_pembayaran = (saldo_pokok + saldo_margin + saldo_tabungan) - potongan_margin;
			   }

			   $("#total_pembayaran","#form_edit").val(number_format(total_pembayaran,0,',','.'));

			   $('#cash_type2').val(response.jenis_pembayaran).attr('selected',true);
			   $('#cash_type').val(response.jenis_pembayaran);
			   $('#account_cash_code2').val(response.account_cash_code).attr('selected',true);
			   $('#account_cash_code').val(response.account_cash_code);
