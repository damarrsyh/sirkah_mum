  ...
  <table cellspacing="0" cellpadding="0" align="center" style="margin-top:10px;">
    <tbody>
      <tr>
        ...
        <td style="padding:5px; text-align: center; border-bottom:solid 1px #555; border-top: solid 1px #555; border-right: solid 1px #555; font-weight: bold; font-size: 9px; width:90px;">ID Anggota</td>
        <td style="padding:5px; text-align: center; border-bottom:solid 1px #555; border-top: solid 1px #555; border-right: solid 1px #555; font-weight: bold; font-size: 9px; width:120px;">Nama</td>
  			<td style="padding:5px; text-align: center; border-bottom:solid 1px #555; border-top: solid 1px #555; border-right: solid 1px #555; font-weight: bold; font-size: 9px; width:120px;">Majelis</td>
  			<td style="padding:5px; text-align: center; border-bottom:solid 1px #555; border-top: solid 1px #555; border-right: solid 1px #555; font-weight: bold; font-size: 9px; width:100px;">Jumlah</td>
      </tr>
      <?php 
        $no=1;
        $total_bahas = 0;
        foreach ($result as $data):
        $total_bahas += $data['amount'];
      ?>
      <tr>
        ...
        <td style="padding:5px; font-size:10px; border-bottom:solid 1px #555; border-right: solid 1px #555; text-align: center;"><?php echo $data['cif_no'];?></td>
      ...
      <?php endforeach?>
      <tr>
        <td colspan="4" style="text-align: right; padding:5px; font-size:10px; border-bottom:solid 1px #555; border-left: solid 1px #555;border-right: solid 1px #555;">Total</td>
        <td style="text-align: right; padding:5px; font-size:10px; border-bottom:solid 1px #555; border-right: solid 1px #555; "><?php echo number_format($total_bahas,0,',','.');?></td>
      </tr>
    </tbody>
</table>
</page>