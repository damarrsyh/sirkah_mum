...
<page>
    <div style="width:100%;">
      ...
      <div style="text-align:center;padding-top:10px;font-family:Arial;font-size:18px;">
        Rekapitulasi NPL Tanggal <?php echo $tanggal;?>
      </div>
      <hr>
    </div>
    <table id="hor-minimalist-b" align="center">
      <thead>  
        <tr>
          ...
          <th valign="middle" align="center" style="width:150px;padding-top:5px;padding-bottom:5px;font-weight:bold;font-size:11px;border:solid 1px #262626;" rowspan="2">PORTOFOLIO AT RISK</th>
          <th valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;font-weight:bold;font-size:11px;border:solid 1px #262626;" rowspan="2">JUMLAH<br>ANGGOTA</th>
          <th valign="middle" align="center" style="width:90px;padding-top:5px;padding-bottom:5px;font-weight:bold;font-size:11px;border:solid 1px #262626;" rowspan="2">OUTSTANDING</th>
          ...
          <th valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;font-weight:bold;font-size:11px;border:solid 1px #262626;" colspan="2">PENYADANGAN</th>
        </tr>
        <tr>
          ...
          <th align="center" style="width:90px;padding-top:5px;padding-bottom:5px;font-weight:bold;font-size:11px;border-right:solid 1px #262626;border-bottom:solid 1px #262626;">JUMLAH</th>
        </tr>
      </thead>
      <tbody>
      <?php
