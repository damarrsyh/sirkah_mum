...
<script type="text/javascript">
      ...
      $("#previewpdf").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_pdf/export_list_saldo_deposito/'+produk);
        }
      });
      ...
      $("#previewxls").click(function(e)
      {
        ...
        if (produk=="") {
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_list_saldo_deposito/'+produk);
        }
      });
