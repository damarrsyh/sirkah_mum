             ...
             <tr>
                ...
                <td>
                  <select name="tanggal_hitung" id="tanggal_hitung" style="width:170px;" class="medium m-wrap chosen">
                    ...
                    <option value="<?php echo $data['tanggal_hitung'];?>"><?php echo date('d-m-Y',strtotime($data['tanggal_hitung']));?></option>
                  <?php endforeach?>
                  </select>
                </td>
             </tr>
  ...
  // })
   ...
   $("#preview_pdf").click(function(e){
      ...
      switch(rekap_by){
        ...
        break;
        case "kol":
        window.open('<?php echo site_url();?>laporan_to_pdf/export_rekapitulasi_kol/'+branch_code+'/'+kol+'/REKAP KOLEKTIBILITAS BY PAR');
        break;
      }
   });
   ...
   $("#preview_xls").click(function(e){
      ...
      switch(rekap_by){
        ...
        if(fa_code==""){
          ...
          window.open('<?php echo site_url();?>laporan_to_excel/export_rekapitulasi_npl2/'+branch_code+'/'+fa_code+'/'+cm_code);
        }
        break;
        case "rembug":
        if(cm_code==""){
        ...
        break;
        case "kol":
        window.open('<?php echo site_url();?>laporan_to_excel/export_rekapitulasi_kol/'+branch_code+'/'+kol);
        break;
      }
   });
