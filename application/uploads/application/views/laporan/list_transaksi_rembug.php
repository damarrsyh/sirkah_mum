  ...
  <div class="portlet-body form">
     ...
     <form action="" method="post" id="form_add" class="form-horizontal">
        ...
        <div class="form-actions">
           <button class="green btn" id="showgrid" type="button">Show Grid</button>
           <button type="button" id="export_pdf" class="btn green">Preview</button>
           <button type="button" id="export_excel" class="btn green">Preview Excel</button>
           <button type="button" id="export_csv" class="btn green">Preview CSV</button>
        </div>
     </form>
      <p><hr></p>
