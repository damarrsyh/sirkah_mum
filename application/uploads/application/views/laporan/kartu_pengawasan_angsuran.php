        ...
        <td>
          ...
          <table align="center" style="border:solid 1px #CCC; margin:10px auto;"  width="60%">
                <tr>
                    ...
                    <td style="background:#EEE; padding:5px;" width="35%" ><input id="res_nama" type="text" style="font-size:12px;width:200px;padding:1px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;border:#eee; background-color:#eee;"></td>
                    <td style="background:#EEE; padding:5px;" width="15%">Plafon</td>
                    <td style="background:#EEE; padding:5px;" width="2%">:</td>
                    <td style="background:#EEE; padding:5px;" width="35%"><input id="res_plafon" type="text" style="font-size:12px;width:200px;padding:1px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;border:#eee; background-color:#eee;"></td>
                </tr>
                <tr>
                    <td style="background:#EEE; padding:5px;" >Rembug</td>
                    <td style="background:#EEE; padding:5px;" >:</td>
                    <td style="background:#EEE; padding:5px;" ><input id="res_rembug" type="text" style="font-size:12px;width:200px;padding:1px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;border:#eee; background-color:#eee;"></td>
                ...
                <tr>
                    ...
                    <td style="background:#EEE; padding:5px;" >:</td>
                    <td style="background:#EEE; padding:5px;" ><input id="res_desa" type="text" style="font-size:12px;width:200px;padding:1px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;border:#eee; background-color:#eee;"></td>
                ...
                <tr>
                    <td style="background:#EEE; padding:5px;" >No. Rek. Tabungan</td>
                    <td style="background:#EEE; padding:5px;" >:</td>
                    <td style="background:#EEE; padding:5px;" ><input id="res_no_rekening_tabungan" type="text" style="font-size:12px;width:200px;padding:1px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;border:#eee; background-color:#eee;"></td>
                    <td style="background:#EEE; padding:5px;" >Status Rekening</td>
                    <td style="background:#EEE; padding:5px;" >:</td>
                    <td style="background:#EEE; padding:5px;" ><input id="res_statrek" type="text" style="font-size:12px;width:200px;padding:1px;margin-top:5px;margin-bottom:5px;box-shadow:0 0 0;border:#eee; background-color:#eee;"></td>
                </tr>
          </table>
