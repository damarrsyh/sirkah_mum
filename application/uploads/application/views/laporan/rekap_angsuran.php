      ...
      $("#previewpdf").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {            
              ...
              {            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_semua_cabang/'+cabang+'/'+tanggal+'/'+tanggal2);
              }        
              else
              {            
                window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_cabang/'+cabang+'/'+tanggal+'/'+tanggal2);
              } 
          } 
          else if (filter=='1') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_rembug/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='2') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_petugas/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='3') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_produk/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='4') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_peruntukan/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='5') 
          {
            window.open('<?php echo site_url();?>laporan_to_pdf/export_rekap_angsuran_sektor_usaha/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else
          {
      ...
      $("#previewxls").click(function(e)
      {
        ...
        var filter = $("#filter").val();
          ...
          {            
              if(cabang=='0000' || cabang=='') 
              {            
                window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_semua_cabang/'+cabang+'/'+tanggal+'/'+tanggal2);
              }        
              else
              {            
                window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_cabang/'+cabang+'/'+tanggal+'/'+tanggal2);
              } 
          } 
          else if (filter=='1') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_rembug/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='2') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_petugas/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='3') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_produk/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='4') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_peruntukan/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else if (filter=='5') 
          {
            window.open('<?php echo site_url();?>laporan_to_excel/export_rekap_angsuran_sektor_usaha/'+cabang+'/'+tanggal+'/'+tanggal2);
          }
          else
          {
            alert("Parameter Kosong");
