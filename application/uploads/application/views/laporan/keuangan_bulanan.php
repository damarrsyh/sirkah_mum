...
/* BEGIN SCRIPT */
   ...
   $("#previewpdf").click(function(e){
		...
		if(jenis == '30'){
        	var periode_hari = $("#date").val().substr(13,2);
        	var periode_bulan = $("#date").val().substr(16,2);
        	var periode_tahun = $("#date").val().substr(19,4);      
    	} else {
        	var periode_hari = $("#date").val().substr(0,2);
        	var periode_bulan = $("#date").val().substr(3,2);
        	var periode_tahun = $("#date").val().substr(6,4);      
    	}
		...
		if(jenis == ''){
			...
			var url = '<?php echo site_url();?>laporan_to_pdf/export_keuangan_labarugi_bulanan';
      		...
      		var url = '<?php echo site_url();?>laporan_to_pdf/export_keuangan_trial_balance';      
    	}
		
		if(conf == true){
			window.open(url+'/'+branch_code+'/'+periode_bulan+'/'+periode_tahun+'/'+periode_hari+'/'+jenis);
		}
   });
   ...
   $("#previewxls").click(function(e){
		...
		if(jenis == ''){
			...
			var url = '<?php echo site_url();?>laporan_to_excel/export_keuangan_trial_balance';      
    	}
