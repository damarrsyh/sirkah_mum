                                ...
                                <div class="row-fluid">
                                   <div class="span12">
                                      ...
                                      ?>
                                        ...
                                        <p class="hide" id="pcm" style="height:37px">
                                        <select id="cm" class="span12 m-wrap chosen" style="width:530px !important;">
                                        <option value="">Pilih Rembug</option>
                                        <?php foreach($rembugs as $rembug): ?>
                                        <option value="<?php echo $rembug['cm_code']; ?>"><?php echo $rembug['cm_name']; ?></option>
...
$(function(){
  ...
  */
  ...
  form1.validate({
    ...
    submitHandler: function (form) {
      ...
      if(cif_type==1){
        if(account_saving==""){
          alert("Anda Belum Memiliki Rekening Tabungan")
        }else if(jaminan==""){
          alert("Jaminan belum di isi !")
        }else if(keterangan_jaminan==""){
          alert("Keterangan Jaminan belum di isi !")
        }else{
			$.ajax({
              type: "POST",
  ...
  */
  $("#product2,#nilai_pembiayaan2,#tgl_akad_edit,#tgl_jtempo_edit",form2).change(function(){
    ...
    var pokok=(isNaN(parseFloat(convert_numeric($("#nilai_pembiayaan2",form2).val())))==true)?0:parseFloat(convert_numeric($("#nilai_pembiayaan",form2).val()));
    var margin=(isNaN(parseFloat(convert_numeric($("#margin_pembiayaan2",form2).val())))==true)?0:parseFloat(convert_numeric($("#margin_pembiayaan",form2).val()));
