...
<div class="row-fluid">
   <div class="span12">
    ...
    <h3 class="page-title">
      Transaction <small>Verifikasi Perpanjang Tabber </small>
    </h3>
    <ul class="breadcrumb">
      <li>
        <i class="icon-home"></i>
...
<div id="add" class="">
   ...
   <div class="portlet box green">
      <div class="portlet-title">
         <div class="caption"><i class="icon-reorder"></i>Verifikasi Perpanjangan Tabber</div>
         <div class="tools">
      ...
      <div class="portlet-body form">
         ...
         <form action="#" id="form_add" class="form-horizontal">
               ...
               <a id="browse_rembug" class="btn blue" data-toggle="modal" href="#dialog_rembug">...</a>
                  ...
                  <div id="tabungan_berencana2">   
                    ...
                    <div class="control-group">
                       <label class="control-label">Jangka Waktu<span class="required">*</span></label>
                       <div class="controls">
                          <input type="text" name="rencana_jangka_waktu_setelah"  style="width:50px;background-color:#eee;" id="rencana_jangka_waktu_setelah" data-required="1" readonly="" class="m-wrap" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="3" />
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                          <input type="text" name="tanggal_perpanjangan" style="width:120px;background-color:#eee;" id="tanggal_perpanjangan" data-required="1" readonly="" class="date-picker small m-wrap"/>
                       </div>
                    </div> 
                    <!-- <div class="control-group">
                       <label class="control-label">Tanggal Jtempo</label>
            ...
            <div class="form-actions">
               <button type="submit" class="btn green">Verif</button>
      ...
      $("#rencana_setoran_next2","#form_add").change(function(){
        ...
        $("#keyword").on('keypress',function(e){
          if(e.which==13){
            ...
            $.ajax({
              type: "POST",
              url: site_url+"cif/search_account_no_by_status_verif",
        ...
        $("#select").click(function(){
            ...
            $.ajax({
              ...
              url: site_url+"rekening_nasabah/get_value_verif",
              success: function(response){
                ...
                $("#rencana_jangka_waktu_setelah").val(response.rencana_jangka_waktu_setelah);
                $("#tanggal_perpanjangan").val(response.tanggal_perpanjangan);
