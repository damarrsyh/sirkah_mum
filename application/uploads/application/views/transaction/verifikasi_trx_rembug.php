          ...
          <table width="100%" id="form">
            <thead>
              ...
              <tr>
                ...
                <td style="background:#EEE;border-right:solid 1px #CCC;border-bottom:solid 1px #CCC;" rowspan="2" valign="middle" align="center">Setoran<br>Pokok</td>
        ...
        success: function(respon){
          ...
          if(response.length>0)
          {
            for ( i = 0 ; i < response.length ; i++ )
            {
              ...
              var akumulasi_penarikan_tab_sukarela = parseFloat(mutasi[i].saldo_pembiayaan_catab)+parseFloat(mutasi[i].saldo_tab_wajib)+parseFloat(mutasi[i].saldo_tab_kelompok)+parseFloat(mutasi[i].saldo_tab_sukarela)+parseFloat(mutasi[i].saldo_tab_berencana);
    ...
    if(conf)
    {
      ...
      $.ajax({
        ...
        error: function(request, status, err){
          $.unblockUI();
		    alert("Failed to Connect into Databases, Please Check Your Internet Connection.");
        }
      });
    }
  });
