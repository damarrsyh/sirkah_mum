        ...
        success: function(respon){
          ...
          if(response.length>0)
          {
            ...
            for ( i = 0 ; i < response.length ; i++ )
            {
              ...
              var akumulasi_penarikan_tab_sukarela = parseFloat(mutasi[i].saldo_pembiayaan_catab)+parseFloat(mutasi[i].saldo_tab_wajib)+parseFloat(mutasi[i].saldo_tab_kelompok)+parseFloat(mutasi[i].saldo_tab_sukarela)+parseFloat(mutasi[i].saldo_tab_berencana)+parseFloat(mutasi[i].bonus_bagihasil);
                          ...
                          <div class="row-fluid"> \
                             <div class="span12"> \
                                <table width="500"> \
                                  ...
                                  <tr> \
                                    <td style="color:#000">Setoran Pokok</td> \
